...
#define SF_CS_0()			GPIO_WriteBit(SF_PORT_CS,SF_PIN_CS,(BitAction)0)
#define SF_CS_1()			GPIO_WriteBit(SF_PORT_CS,SF_PIN_CS,(BitAction)1)
...
void sf_ReadInfo(void)
{
	/* 自动识别串行Flash型号 */
      ...
      case W25Q32JV_ID:
		...
		printf("FLASH %s JEDEC ID:%#x \r\n",g_tSF.ChipName,g_tSF.ChipID);
}
