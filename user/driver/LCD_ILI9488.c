...
ILI9488_DrawRect(20,20,100,100,0x2f);
#endif
}
#else
void Init_9488(void)
{
		...
		ILI9488_WriteParam(0x9B);
		ILI9488_WriteParam(0x49);
		ILI9488_WriteParam(0x09);
		ILI9488_WriteParam(0x06);
		ILI9488_WriteParam(0x0b);
		ILI9488_WriteParam(0x1D);
		ILI9488_WriteParam(0x1E);
		ILI9488_WriteParam(0x0F);
		...
		ILI9488_WriteParam(0x06);
		ILI9488_WriteParam(0x36);
		ILI9488_WriteParam(0x46);
		ILI9488_WriteParam(0x47);
		...
		ILI9488_WriteCmd(0x36);
		ILI9488_WriteParam(0x48);   

		ILI9488_WriteCmd(0x3a);    
		ILI9488_WriteParam(0x55);
