...
#define CC1101_PA_POWER         0xC0

#define CC1101_RF_CH_TEST       4
#define CC1101_RF_CH_MAX        4
...
{
  uint8_t u8DataLen;
  uint8_t u8Buff[CC1101_PACKET_SIZE];
}CC1101_PACKET;
...
extern void CC1101_ReadPacket(void);
extern void CC1101_Recovery(void);
extern inline void CC1101_EnterRXMode(void);
extern void CC1101_ChangeRFCH(uint8_t u8RFCH);
...
#define FLAG_ENABLE_JOIN                ((uint16_t)0x0008)
#define FLAG_LVLIGHT_ENABLE             ((uint16_t)0x0010)
#define FLAG_TEST_MODE                  ((uint16_t)0x8000)
#endif